...
public class id_error extends JFrame {
    ...
    public id_error() {
        ...
        lb.setIcon(new ImageIcon("C:\\Users\\user\\OneDrive\\���� ȭ��\\error.png"));
        lb.setBounds(46, 105, 95, 75);
        contentPane.add(lb);
        
        JLabel lb_1 = new JLabel("�������� �ʴ� ID�Դϴ�!");
        lb_1.setFont(new Font("HY����M", Font.BOLD, 17));
        lb_1.setBounds(130, 105, 244, 85);
        contentPane.add(lb_1);
        
        JLabel lb_2 = new JLabel("�г���");
        lb_2.setFont(new Font("HY����M", Font.BOLD, 15));
        lb_2.setBounds(46, 205, 73, 34);
        contentPane.add(lb_2);
        
        textField = new JTextField();          //������ �г��� �Է¹��� textfield
        textField.setBounds(97, 200, 182, 39);
        contentPane.add(textField);
        textField.setColumns(10);
        
        JButton btn_create = new JButton("����");    //�г��� ���� ��ư
        btn_create.setFont(new Font("HY����M", Font.PLAIN, 12));
